                ...
                <div class="row">
                    ...
                    <div class="col-lg-5 col-md-12 ">
                        <div class="my-container appointment-inner">
                            <div>
                                <img class="avatar" src="${requestScope.doctor != null ? requestScope.doctor.avatar : "https://static.vecteezy.com/system/resources/previews/000/439/863/original/vector-users-icon.jpg"}" />
                            </div>
